...
public class StatusBarUtils {
    ...
    private int contentResourseIdInDrawer;
    ...
    public StatusBarUtils setDrawerLayoutContentId(boolean drawerLayout, int contentId) {
        ...
        contentResourseIdInDrawer = contentId;
        return this;
    }
    ...
    public void init() {
        ...
        if (crawable != null) {
            ...
            addStatusViewWithDrawble(activity, crawable);
        }
        if (isDrawerLayout()) {
        ...
        if (isActionBar()) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                ...
                rootView.setPadding(0, getStatusBarHeight(activity) + getActionBarHeight
                        (activity), 0, 0);
            }
        }
    ...
    private void addStatusViewWithColor(Activity activity, int color) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (isDrawerLayout()) {
                ...
                DrawerLayout drawer = (DrawerLayout) parentView;
                //内容视图
                View content = activity.findViewById(contentResourseIdInDrawer);
                ...
                ViewGroup rootView = (ViewGroup) this.activity.getWindow().getDecorView()
                        .findViewById(android.R.id.content);
                rootView.setPadding(0, getStatusBarHeight(this.activity), 0, 0);
