 ...
 * @fix：
 */
public class VerticaMarqueelTextView extends TextSwitcher implements ViewSwitcher.ViewFactory {
    ...
    public VerticaMarqueelTextView(Context context) {
        this(context, null);
        mContext = context;
    }

    public VerticaMarqueelTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
