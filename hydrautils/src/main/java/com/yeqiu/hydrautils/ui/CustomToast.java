...
public class CustomToast {
    ...
    public static void normal(@NonNull String message) {
        normal(HydraUtilsManager.getInstance().getContext(), message, Toast.LENGTH_SHORT, null,
                false).show();
    }

    public static void normal(@NonNull String message, Drawable icon) {
        normal(HydraUtilsManager.getInstance().getContext(), message, Toast.LENGTH_SHORT, icon,
                true).show();
    }

    public static void normal(@NonNull String message, int duration) {
        normal(HydraUtilsManager.getInstance().getContext(), message, duration, null, false).show();
    }

    public static void normal(@NonNull String message, int duration, Drawable icon) {
        normal(HydraUtilsManager.getInstance().getContext(), message, duration, icon, true).show();
    }

    public static Toast normal(@NonNull String message, int duration, Drawable icon, boolean
            withIcon) {
        return custom(HydraUtilsManager.getInstance().getContext(), message, icon,
                DEFAULT_TEXT_COLOR, duration, withIcon);
    }

    public static void warning(@NonNull String message) {
        warning(HydraUtilsManager.getInstance().getContext(), message, Toast.LENGTH_SHORT, true)
                .show();
    }

    public static void warning(@NonNull String message, int duration) {
        warning(HydraUtilsManager.getInstance().getContext(), message, duration, true).show();
    }

    public static Toast warning(@NonNull String message, int duration, boolean withIcon) {
        return custom(HydraUtilsManager.getInstance().getContext(), message, getDrawable
                        (HydraUtilsManager.getInstance().getContext(), R.drawable
                        .ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration,
                withIcon, true);
    }

    public static void info(@NonNull String message) {
        info(HydraUtilsManager.getInstance().getContext(), message, Toast.LENGTH_SHORT, true)
                .show();
    }

    public static void info(@NonNull String message, int duration) {
        info(HydraUtilsManager.getInstance().getContext(), message, duration, true).show();
    }

    public static Toast info(@NonNull String message, int duration, boolean withIcon) {
        return custom(HydraUtilsManager.getInstance().getContext(), message, getDrawable
                        (HydraUtilsManager.getInstance().getContext(), R.drawable
                        .ic_info_outline_white_48dp), DEFAULT_TEXT_COLOR, INFO_COLOR, duration,
                withIcon,
                true);
    }

    public static void success(@NonNull String message) {
        success(HydraUtilsManager.getInstance().getContext(), message, Toast.LENGTH_SHORT, true)
                .show();
    }

    public static void success(@NonNull String message, int duration) {
        success(HydraUtilsManager.getInstance().getContext(), message, duration, true).show();
    }

    public static Toast success(@NonNull String message, int duration, boolean withIcon) {
        return custom(HydraUtilsManager.getInstance().getContext(), message, getDrawable
                (HydraUtilsManager.getInstance().getContext(), R.drawable
                .ic_check_white_48dp), DEFAULT_TEXT_COLOR, SUCCESS_COLOR, duration, withIcon, true);
    }

    public static void error(@NonNull String message) {
        error(HydraUtilsManager.getInstance().getContext(), message, Toast.LENGTH_SHORT, true)
                .show();
    }
    ...
    public static void error(@NonNull String message, int duration) {
        error(HydraUtilsManager.getInstance().getContext(), message, duration, true).show();
    }

    public static Toast error(@NonNull String message, int duration, boolean withIcon) {
        return custom(HydraUtilsManager.getInstance().getContext(), message, getDrawable
                (HydraUtilsManager.getInstance().getContext(), R.drawable
                .ic_clear_white_48dp), DEFAULT_TEXT_COLOR, ERROR_COLOR, duration, withIcon, true);
    }
    ...
    public static Toast warning(@NonNull Context context, @NonNull String message, int duration,
                                boolean withIcon) {
        return custom(context, message, getDrawable(context, R.drawable
                        .ic_error_outline_white_48dp), DEFAULT_TEXT_COLOR, WARNING_COLOR, duration,
                withIcon, true);
    }
    ...
    @CheckResult
    public static Toast custom(@NonNull Context context, @NonNull String message, @DrawableRes
            int iconRes, @ColorInt int textColor, @ColorInt int tintColor, int duration, boolean
                                       withIcon, boolean shouldTint) {
        return custom(context, message, getDrawable(context, iconRes), textColor, tintColor,
    ...
    public static Toast custom(@NonNull Context context, @NonNull String message, Drawable icon,
        ...
        if (withIcon) {
            if (icon == null) {
                throw new IllegalArgumentException("Avoid passing 'icon' as null if 'withIcon' is" +
                        " set to true");
            }
    ...
    public static final Drawable tint9PatchDrawableFrame(@NonNull Context context, @ColorInt int
            tintColor) {
        final NinePatchDrawable toastDrawable = (NinePatchDrawable) getDrawable(context, R
    ...
    public static void showToastShort(String str) {
        Toast.makeText(HydraUtilsManager.getInstance().getContext(), str, Toast.LENGTH_SHORT)
                .show();
    }
    ...
    public static void showToastShort(int resId) {
        Toast.makeText(HydraUtilsManager.getInstance().getContext(), HydraUtilsManager
                .getInstance().getContext().getString(resId), Toast
                .LENGTH_SHORT).show();
    }
    ...
    public static void showToastLong(String str) {
        Toast.makeText(HydraUtilsManager.getInstance().getContext(), str, Toast.LENGTH_LONG).show();
    }
    ...
    public static void showToast(String msg) {
        if (mToast == null) {
            mToast = Toast.makeText(HydraUtilsManager.getInstance().getContext(), msg, Toast
                    .LENGTH_LONG);
        } else {
            mToast.setText(msg);
        }
    ...
    public static void showToast(int resId) {
        if (mToast == null) {
            mToast = Toast.makeText(HydraUtilsManager.getInstance().getContext(),
                    HydraUtilsManager.getInstance().getContext().getString(resId),
                    Toast.LENGTH_LONG);
        } else {
            mToast.setText(HydraUtilsManager.getInstance().getContext().getString(resId));
        }
        mToast.show();
    }
